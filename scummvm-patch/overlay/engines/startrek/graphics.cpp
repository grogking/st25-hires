...
void Graphics::setMouseBitmap(Common::String bitmapName) {
	...
	// Push so textbox/options can pop and restore the previous cursor.
...
void Graphics::replaceMouseBitmap(Common::String bitmapName) {
	Bitmap *bitmap = new Bitmap(_vm->_resource->loadBitmapFile(bitmapName));
